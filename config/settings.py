...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "lectomlv"),
        "USER": os.getenv("POSTGRES_USER", "lectomlv"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "lectomlv"),
...
CELERY_TASK_SOFT_TIME_LIMIT = 540  # 9분
...
# FAISS / Embedding
FAISS_INDEX_DIR = os.getenv("FAISS_INDEX_DIR", str(BASE_DIR / "faiss_index"))
